...
public class PrinterErrors {
    ...
    public static void main(String[] args) {
        System.out.println(printerErrorBest("aaabbbbhaijjjm"));
        System.out.println(printerErrorBest("aaaxbbbbyyhwawiwjjjwwm"));
        System.out.println(printerErrorBest("aaabbbbhaijjjm"));
        System.out.println(printerErrorBest("aaaxbbbbyyhwawiwjjjwwm"));
    }
    ...
    public static String printerError(String str) {
        String validSymbols = "(?i)[a-m]";
        int codeLength = str.length();
        int errorsCount = str.replaceAll(validSymbols, "").length();
        return String.format("%d/%d", errorsCount, codeLength);
    }

    /** Best solution **/
    public static String printerErrorBest(String str) {
